...
public class WB_Play7 extends CCColorLayer {

	private List<WB_Sprite> _Drip = new CopyOnWriteArrayList<WB_Sprite>();//ˮ��
	
	private List<WB_Sprite> _Snow3=new CopyOnWriteArrayList<WB_Sprite>();//ѩ��3
	private List<WB_Sprite> _Snow2=new CopyOnWriteArrayList<WB_Sprite>();//ѩ��2
	private List<WB_Sprite> _Snow1=new CopyOnWriteArrayList<WB_Sprite>();//ѩ��1
	
	
	private List<WB_Sprite> _Ice2=new CopyOnWriteArrayList<WB_Sprite>();//��2
	private List<WB_Sprite> _Ice1=new CopyOnWriteArrayList<WB_Sprite>();//��1
	
	
//	private List<WB_Sprite> _BigDrip=new CopyOnWriteArrayList<WB_Sprite>();//�ٲ�
	private List<CCSprite> _Dec_Prop = new CopyOnWriteArrayList<CCSprite>();//ˮ�����ٵ���
	private List<CCSprite> _Inc_Prop = new CopyOnWriteArrayList<CCSprite>();//ˮ�����ӵ���
	private List<CCSprite> _Wudi_Prop = new CopyOnWriteArrayList<CCSprite>();//�޵е���
	private List<CCSprite> _Bomb_Prop = new CopyOnWriteArrayList<CCSprite>();//ȫ��ը������
...
//	private List<WB_Sprite> _AllDrip = new CopyOnWriteArrayList<WB_Sprite>();//����ˮ��
	private List<Long> Award_Score=new ArrayList<Long>();
	private CCLabel _ScoreLabel;//����
	private CCLabel _Hp_Num;
	private CCLabel _Wudi_Num;//��ɫը������
	private CCLabel _Bomb_Num;//��ɫը������
...
//	private CCSprite _WB_Back;
	private CCSprite _Wudi;//��ɫը��
	private CCSprite _Bomb;//��ɫը��
	private CCSprite _WB_Play;
	private CCSprite _WB_Pause;//��ͣ
...
//	private CCSprite  _Ban4;
	...
	private String _Cookie_Font = "Cookies.ttf";//����
	
	private String _WB_Back_Path = "images/playgamebg.png";//��Ļ����
//	private String _WB_Back_Path1 = "images/playgamebg1.png";//��Ļ����
//	private String _WB_Back_Path2 = "images/playgamebg2.png";//��Ļ����
//	private String _WB_Back_Path3 = "images/playgamebg3.png";//��Ļ����
	private String _SmallDrip_Path = "images/drip.png";//Сdrip
	
	private String _Snow3_Path = "images/snow3.png";//Сdrip
	private String _Snow2_Path = "images/snow2.png";//Сdrip
	private String _Snow1_Path = "images/snow1.png";//Сdrip
	private String _Ice2_Path = "images/ice2.png";//Сdrip
	private String _Ice1_Path = "images/ice1.png";//Сdrip
...
//	private int _Play_Image_Chage = 1;// �ɻ�ͼƬ�ж�
	...
	private float _Total_Distance=0;
	
    private float _Ice2_Dis;
    private float _Ice1_Dis;
    private float _Snow3_Dis;
    private float _Snow2_Dis;
    private float _Snow1_Dis;
    private float _Dript_Dis;
...
//	private int _ChangeImage_Delay = -1;// ͼƬ�ı���ʱ
	...
	private int Wudi_Num;
	private int Bomb_Num ;// ��ը������
	private int Hp_Num;
	private int Prop_Down_Time = 30;// ���ӵ��ͺ�ը���������
	private int DripDown_Time = 8;// �л��������ٶ�
	private int Capa=25;//ˮ��
//	private int origin_capa=123;//�����Աȵ�ˮ��
	private int Season=1;
	private int non_drip=0;//�˱������ж��Ƿ���3����û����ˮ
	private int place ;
	private int win_count=0;//ͨ�ر���
...
//	private boolean _Invincible = false;//�޵�
   //��������ֵ�ж��Ƿ���һ������ֵ�ڽ��ܹ�20% 4%��ˮ���ͷ�
	...
	protected WB_Play7(ccColor4B color,int a,int b,int c,int d,int e,int f) {
		super(color);
	...
	private void Init() {
		...
		genDate();	setWinTipOr(originDate);
...
//		}
		...
		_WB_Back.setPosition(CGPoint.make(_WinSize.width / 2,_WinSize.height / 2));// Ĭ�����ĵ�Ϊ���½ǣ����������ĵ��Ƶ���Ļ�м�
		addChild(_WB_Back);// ��������ӵ�����
	...
	public void Prop_Back2(Object sender) {
		...
		CCFiniteTimeAction fs_timeAction = CCMoveTo.action(
				...
				CGPoint.ccp(prop.getPosition().x,
						-(prop.getContentSize().height / 2)));// ʱ�����ƶ�
...
//		}
	...
	{
		//��ˮ����Ӵ���ˮʱ��ˮ�������Ӵ��롣�Ӵ����ϰ��Ĵ��� ��ʹ���˵��ߵĴ���;���ֳͷ���ʵ�ִ��룻
		//��������Ϊ0ʱ����������
    	...
    	if(Capa<=0&&!haveChangePic0)
    	{
 			...
 			haveChangePic124=false;
    		Hp_Num--;
    		//���γͷ�Ч������Ϊ��ʼfalse������������ʼ��������µĳͷ��������20%��4%,�����������õ�Ŀ���Ƿ�ֹ��γͷ�
	...
	private void ShowDialog() {
		CCDirector.sharedDirector().getActivity().runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				View v = inflater.inflate(R.layout.wb_dialog, null);// �õ�����view
...
//	}
   ...
   private void AddDrip()
   {
	   ...
	   Random rand = new Random();
//	   int randomValue=0;
		int randomValue = rand.nextInt(30);//0-29�������
...
//		}
		//��������
		if(randomValue>0&&randomValue<=3&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
		...
		//��������
		if(randomValue>=4&&randomValue<=9&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
		...
		//�ļ�����
		if(randomValue>=9&&randomValue<=25&&Season==2)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
...
//	   int randomValue=0;
		...
		//��������
		if(randomValue>0&&randomValue<=20&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_Snow3_Path);
			DripDown(wb_drip, 4);
		}
		if(randomValue>20&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_Snow2_Path);
			DripDown(wb_drip,3);
		}
		//��������
		if(randomValue>=4&&randomValue<=20&&(Season==1||Season==4))
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_Snow1_Path);
			DripDown(wb_drip, 2);
		}
		if(randomValue<4&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_Snow2_Path);
   ...
   private void AddIce()
   {
	   ...
	   Random rand = new Random();
//	   int randomValue=0;
		int randomValue = rand.nextInt(5);//0-29�������
		WB_Sprite wb_drip=new WB_Sprite();
		wb_drip.setClicked_Or(false);
		

		//��������
		if(randomValue>0&&randomValue<=5&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_Ice2_Path);
			DripDown(wb_drip, 6);
		}
		
		//��������
		if(randomValue==0&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_Ice1_Path);
			DripDown(wb_drip, 5);
		}
  ...
  {
	  Random rand = new Random();
		int minX = (int) (wb_drip.getCCSprite().getContentSize().width / 2.0f);//��С������
		int maxX = (int) (_WinSize.width - wb_drip.getCCSprite()
				.getContentSize().width / 2.0f);//��������
		int rangeX = maxX - minX;
		int actualX = rand.nextInt(rangeX) + minX;
		int minDuration = DripDown_Time - 4;//FoeDown_TimeΪ�½��ٶ� ��ʼΪ8
		...
		addChild(wb_drip.getCCSprite());
			...
			case 1:
				...
				break;
			case 2:
				wb_drip.getCCSprite().setTag(2);
				_Snow1.add(wb_drip);
				break;
			case 3:
				wb_drip.getCCSprite().setTag(3);
				_Snow2.add(wb_drip);
				break;

			case 4:
				wb_drip.getCCSprite().setTag(4);
				_Snow3.add(wb_drip);
				break;
			case 5:
				wb_drip.getCCSprite().setTag(5);
				_Ice1.add(wb_drip);
				break;
			case 6:
				wb_drip.getCCSprite().setTag(6);
				_Ice2.add(wb_drip);
				break;
...
//        setDownDistance(wb_drip);
        ...
        setChangeDis(tag);
		CCFiniteTimeAction fs_timeAction = CCMoveTo.action(_Down_Duration,CGPoint.ccp(actualX, _Down_Distance));// ʱ�����ƶ�
		System.out.println("Down dis:"+ _Down_Distance);
		CCCallFuncN fs_Over = null; //����
		if (tag == 1)
			fs_Over = CCCallFuncN.action(this, "Drip_Over");
          if(tag==2)
        	  fs_Over = CCCallFuncN.action(this, "Snow1_Over");
          if(tag==3)
        	  fs_Over = CCCallFuncN.action(this, "Snow2_Over"); 
          if(tag==4)
        	  fs_Over = CCCallFuncN.action(this, "Snow3_Over"); 
          if(tag==5)
        	  fs_Over = CCCallFuncN.action(this, "Ice1_Over"); 
          if(tag==6)
        	  fs_Over = CCCallFuncN.action(this, "Ice2_Over"); 
		CCSequence fs_actions = CCSequence.actions(fs_timeAction, fs_Over);//�˶���ʼ������
  ...
  /**
	 * ����ʱ���λ�ã��������
	 */
	private void Down( int i,float x, float y,float dis,float duration) {
		WB_Sprite wb_drip=new WB_Sprite();
      switch(i)
		{
		case 1:
			...
			wb_drip.setCCSprite(_SmallDrip_Path);
			wb_drip.setInitDuration(duration);
			wb_drip.getCCSprite().setPosition(x, y);
			addChild(wb_drip.getCCSprite());
			wb_drip.getCCSprite().setTag(1);
			_Drip.add(wb_drip);
			break;
	...
	public void Drip_Over(Object sender) {
		...
		float x=drip_over.getPosition().x;
		float y=drip_over.getPosition().y;
		setSeason();
		if(y>0&&Season==4)
		{
			...
			Down(2,x,y,y-_Snow1_Dis,_Down_Duration);
			
		}
		if(y<0||Season==1||Season==2||Season==3)
			drip_over.removeSelf();
	...
	public void Snow1_Over(Object sender) {
		CCSprite drip_over = (CCSprite) sender;
		float x=drip_over.getPosition().x;
		float y=drip_over.getPosition().y;
		setSeason();
		if(y>0&&Season==1)
		{
			...
			setChangeDis(1);
			System.out.println("y:"+y+",dDis:"+_Dript_Dis);
			Down(1,x,y,y-_Dript_Dis,_Down_Duration);
		...
		if(y>0&&Season==4)
		{
			...
			Down(3,x,y,y-_Snow2_Dis,_Down_Duration);
			
		}
        if(y<=0)
        	drip_over.removeSelf();
        if(y>=0&&(Season==2||Season==3))
        	drip_over.removeSelf();
		for (int i = 0; i < _Snow1.size(); i++) {
			WB_Sprite drip = _Snow1.get(i);
			if (drip.getCCSprite() == drip_over) {
				_Snow1.remove(i);
				break;
			}
	...
	public void Snow2_Over(Object sender) {
		CCSprite drip_over = (CCSprite) sender;
		float x=drip_over.getPosition().x;
		float y=drip_over.getPosition().y;
		setSeason();
		...
		if(y>0&&Season==4)
		{
			...
			Down(4,x,y,y-_Snow3_Dis,_Down_Duration);
		...
		if(y<=0)
		 ...
		 if(y>=0&&(Season==2||Season==3))
	        	drip_over.removeSelf();
		for (int i = 0; i < _Snow2.size(); i++) {
			WB_Sprite drip = _Snow2.get(i);
			if (drip.getCCSprite() == drip_over) {
				_Snow2.remove(i);
				break;
			}
	...
	public void Snow3_Over(Object sender) {
		CCSprite drip_over = (CCSprite) sender;
		float x=drip_over.getPosition().x;
		float y=drip_over.getPosition().y;
		setSeason();
		...
		if(y>0&&Season==4)
		{
			...
			Down(5,x,y,y-_Ice1_Dis,_Down_Duration);
		...
		if(y<=0)
		 ...
		 if(y>=0&&(Season==2||Season==3))
	        	drip_over.removeSelf();
		for (int i = 0; i < _Snow3.size(); i++) {
			WB_Sprite drip = _Snow3.get(i);
			if (drip.getCCSprite() == drip_over) {
				_Snow3.remove(i);
				break;
			}
	...
	public void Ice1_Over(Object sender) {
		CCSprite drip_over = (CCSprite) sender;
//		drip_over.removeSelf();
		float x=drip_over.getPosition().x;
		float y=drip_over.getPosition().y;
		...
		if(y>0&&Season==4)
		{
			...
			Down(6,x,y,y-_Ice2_Dis,_Down_Duration);
		...
		if(y<=0)
		 ...
		 if(y>=0&&(Season==2||Season==3))
	        	drip_over.removeSelf();
		for (int i = 0; i < _Ice1.size(); i++) {
			WB_Sprite drip = _Ice1.get(i);
			if (drip.getCCSprite() == drip_over) {
				_Ice1.remove(i);
				break;
			}
	...
	public void Ice2_Over(Object sender) {
		CCSprite drip_over = (CCSprite) sender;
		drip_over.removeSelf();
		float x=drip_over.getPosition().x;
		float y=drip_over.getPosition().y;
		...
		if(y<=0)
		 ...
		 if(y>=0&&(Season==2||Season==3))
	        	drip_over.removeSelf();
		for (int i = 0; i < _Ice2.size(); i++) {
			WB_Sprite drip = _Ice2.get(i);
			if (drip.getCCSprite() == drip_over) {
				_Ice1.remove(i);
				break;
			}
...
//	}
	...
	private void setChangeDis(int tag)
	{
		switch(Season)
		{
		case 1:
		      _Ice2_Dis=_WinSize.height*8/10;
		      _Ice1_Dis=_WinSize.height*7/10;
		      _Snow3_Dis=_WinSize.height*5/10;
		      _Snow2_Dis=_WinSize.height*4/10;
		      _Snow1_Dis=_WinSize.height*3/10;
		      _Dript_Dis=_WinSize.height;
			break;
		case 2:
			  _Dript_Dis=_WinSize.height*2/3;
		    break;
		case 3:

			  _Dript_Dis=_WinSize.height*3/4;
			 
			break;
		  case 4:
			  _Dript_Dis=_WinSize.height/2;
			  _Snow1_Dis=_WinSize.height*6/10;
			  _Snow2_Dis=_WinSize.height*7/10;
			  _Snow3_Dis=_WinSize.height*8/10;
			  _Ice1_Dis=_WinSize.height*9/10;
			  _Ice2_Dis=_WinSize.height;
		...
		{
		case 1:
			_Down_Distance=_WinSize.height-_Dript_Dis;
			break;
		case 2:
			_Down_Distance=_WinSize.height-_Snow1_Dis;
			break;
		case 3:
			_Down_Distance=_WinSize.height-_Snow2_Dis;
			break;
		case 4:
			_Down_Distance=_WinSize.height-_Snow3_Dis;
			break;
		case 5:
			_Down_Distance=_WinSize.height-_Ice1_Dis;
			break;
		case 6:
			_Down_Distance=_WinSize.height-_Ice2_Dis;
			break;
		}
		System.out.print("eachDis:"+_Down_Distance);
	}
...
//						_Play_Sequence_Path, 99, 123, 4);
		...
		for (int j = 0; j < _Snow1.size(); j++) {
			WB_Sprite drip = _Snow1.get(j);
			CGRect Rect2 = drip.getCCSprite().getBoundingBox();
              if (CirCleinterRect(Rect_Ball.size.width/2,Rect_Ball.origin.x+Rect_Ball.size.width/2,Rect_Ball.origin.y+Rect_Ball.size.height/2,
					Rect2.origin.x,Rect2.origin.y,Rect2.size.width,Rect2.size.height)&&!usewudi) {
                    non_drip=0;
               drip.getCCSprite().removeSelf();
				_Snow1.remove(j);
		...
		for (int j = 0; j < _Snow2.size(); j++) {
			WB_Sprite drip = _Snow2.get(j);
			CGRect Rect2 = drip.getCCSprite().getBoundingBox();
              if (CirCleinterRect(Rect_Ball.size.width/2,Rect_Ball.origin.x+Rect_Ball.size.width/2,Rect_Ball.origin.y+Rect_Ball.size.height/2,
					Rect2.origin.x,Rect2.origin.y,Rect2.size.width,Rect2.size.height)&&!usewudi) {
                    non_drip=0;
		...
		for (int j = 0; j < _Snow3.size(); j++) {
			WB_Sprite drip = _Snow3.get(j);
			CGRect Rect2 = drip.getCCSprite().getBoundingBox();
              if (CirCleinterRect(Rect_Ball.size.width/2,Rect_Ball.origin.x+Rect_Ball.size.width/2,Rect_Ball.origin.y+Rect_Ball.size.height/2,
					Rect2.origin.x,Rect2.origin.y,Rect2.size.width,Rect2.size.height)&&!usewudi) {
                    non_drip=0;
		...
		for (int j = 0; j < _Ice1.size(); j++) {
			WB_Sprite drip = _Ice1.get(j);
			CGRect Rect2 = drip.getCCSprite().getBoundingBox();
              if (CirCleinterRect(Rect_Ball.size.width/2,Rect_Ball.origin.x+Rect_Ball.size.width/2,Rect_Ball.origin.y+Rect_Ball.size.height/2,
					Rect2.origin.x,Rect2.origin.y,Rect2.size.width,Rect2.size.height)&&!usewudi) {
                    non_drip=0;
		...
		for (int j = 0; j < _Ice2.size(); j++) {
			WB_Sprite drip = _Ice2.get(j);
			CGRect Rect2 = drip.getCCSprite().getBoundingBox();
              if (CirCleinterRect(Rect_Ball.size.width/2,Rect_Ball.origin.x+Rect_Ball.size.width/2,Rect_Ball.origin.y+Rect_Ball.size.height/2,
					Rect2.origin.x,Rect2.origin.y,Rect2.size.width,Rect2.size.height)&&!usewudi) {
                    non_drip=0;
				...
				if(Rect_Inc!=null&&CGRect.containsPoint(Rect_Inc, Location))
						{
					       ...
					       Prop.removeSelf();
					       Capa+=5;
//					       origin_capa=Capa;//ˮ���仯�� origin_capa����ͬʱ�仯
					       AddCapa();
					       AddCapaUpDown("+5");
						}
...
//        }
	...
	private void AddCapaUpDown(String s)
	{
		...
		addChild(_Capa_UpDown);// ��������ӵ�����
	}
	private void ReMoveAll(){
		List<WB_Sprite> _DripAll=_Drip;
		List<WB_Sprite> _Snow1All=_Snow1;
		List<WB_Sprite> _Snow2All=_Snow2;
		List<WB_Sprite> _Snow3All=_Snow3;
		List<WB_Sprite> _Ice1All=_Ice1;
		List<WB_Sprite> _Ice2All=_Ice2;
...
//			origin_capa=Capa;
		...
		for(int i=0;i<_Snow1All.size();i++)
		{
			WB_Sprite drip=_Snow1All.get(i);
			ChageScore(200);
			Capa+=2;
//			origin_capa=Capa;
			AddScore();
		...
		_Snow1.removeAll(_DripAll);
		
		for(int i=0;i<_Snow2All.size();i++)
		{
			WB_Sprite drip=_Snow2All.get(i);
			ChageScore(500);
			Capa+=3;
//			origin_capa=Capa;
			AddScore();
		...
		_Snow2.removeAll(_DripAll);
		for(int i=0;i<_Snow3All.size();i++)
		{
			WB_Sprite drip=_Snow3All.get(i);
			ChageScore(800);
			Capa+=4;
//			origin_capa=Capa;
			AddScore();
		...
		_Snow3.removeAll(_DripAll);
		
		for(int i=0;i<_Ice1All.size();i++)
		{
			WB_Sprite drip=_Ice1All.get(i);
			ChageScore(1000);
			Capa+=5;
//			origin_capa=Capa;
			AddScore();
		...
		_Ice1.removeAll(_DripAll);
		for(int i=0;i<_Ice2All.size();i++)
		{
			WB_Sprite drip=_Ice2All.get(i);
			ChageScore(2000);
			Capa+=6;
//			origin_capa=Capa;
			AddScore();
...
//		_BigDrip.removeAll(_BigDripAll);
	...
	private void WinGame()
	{
		ReMoveAll();
		Intent mainScore = new Intent(
				CCDirector.sharedDirector().getActivity(),WB_Win.class);
