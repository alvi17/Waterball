...
public class WB_Play4 extends CCColorLayer {
...
//	private boolean _Invincible = false;//�޵�
   //��������ֵ�ж��Ƿ���һ������ֵ�ڽ��ܹ�20% 4%��ˮ���ͷ�
    ...
    protected WB_Play4(ccColor4B color,int a,int b,int c,int d,int e,int f) {
		super(color);
...
//		}
		...
		//��������
		if(randomValue>=7&&randomValue<=14&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
		...
		//�ļ�����
		if(randomValue>=14&&randomValue<=23&&Season==2)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
