...
public class WB_Play3 extends CCColorLayer {
...
//	private boolean _Invincible = false;//�޵�
   //��������ֵ�ж��Ƿ���һ������ֵ�ڽ��ܹ�20% 4%��ˮ���ͷ�
    ...
    protected WB_Play3(ccColor4B color,int a,int b,int c,int d,int e,int f) {
		super(color);
...
//		}
		...
		//��������
		if(randomValue>=5&&randomValue<=10&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
...
//	}
	private void setDownDistance(WB_Sprite wb_drip)
	{
		...
		case 2:
		    ...
		    break;
		case 3:
			_Down_Distance=_WinSize.getHeight()/2;
			break;
		case 4:
