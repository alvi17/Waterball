...
public class WB_Play5 extends CCColorLayer {
...
//	private boolean _Invincible = false;//�޵�
   //��������ֵ�ж��Ƿ���һ������ֵ�ڽ��ܹ�20% 4%��ˮ���ͷ�
	...
	protected WB_Play5(ccColor4B color,int a,int b,int c,int d,int e,int f) {
		super(color);
...
//	   int randomValue=0;
		...
		//��������
		if(randomValue>0&&randomValue<=7&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
		...
		//��������
		if(randomValue>=8&&randomValue<=14&&Season==2)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
		...
		//�ļ�����
		if(randomValue>=15&&randomValue<=26&&Season==3)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
...
//	   int randomValue=0;
		...
		//��������
		if(randomValue>=27&&randomValue<=20&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
  ...
  /**
	...
	private void setDownDistance(WB_Sprite wb_drip)
	{
		...
		case 1:
			...
			break;
		case 2:
			_Down_Distance=_WinSize.getHeight()/8;
		    break;
		case 3:
			_Down_Distance=_WinSize.getHeight()/10;
			break;
		case 4:
			_Down_Distance=-(wb_drip.getCCSprite().getContentSize().height / 2);
			break;
