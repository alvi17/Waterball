...
public class WB_Play2 extends CCColorLayer {
...
//	private boolean _Invincible = false;//�޵�
   //��������ֵ�ж��Ƿ���һ������ֵ�ڽ��ܹ�20% 4%��ˮ���ͷ�
	...
	protected WB_Play2(ccColor4B color,int a,int b,int c,int d,int e,int f) {
		super(color);
...
//	   int randomValue=0;
		...
		//��������
		if(randomValue>0&&randomValue<=7&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
		...
		//��������
		if(randomValue>=8&&randomValue<=14&&Season==1)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
		...
		//�ļ�����
		if(randomValue>=15&&randomValue<=23&&Season==2)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
			wb_drip.setCCSprite(_SmallDrip_Path);
