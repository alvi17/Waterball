...
public class WB_Play1 extends CCColorLayer {
...
//	private boolean _Invincible = false;//�޵�
   //��������ֵ�ж��Ƿ���һ������ֵ�ڽ��ܹ�20% 4%��ˮ���ͷ�
	...
	protected WB_Play1(ccColor4B color,int a,int b,int c,int d,int e,int f) {
		super(color);
...
//	   int randomValue=0;
		...
		//��������
		if(randomValue>=4&&randomValue<=10&&(Season==1||Season==4))
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
...
//	   int randomValue=0;
		...
		//��������
		if(randomValue>0&&randomValue<=1&&Season==4)
		{
			wb_drip.setLift(_Small_life);
			wb_drip.setMax_Life(_Small_life);
  ...
  /**
	...
	public void Drip_Over(Object sender) {
		...
		if(y>0&&Season==4)
		{
			...
			setChangeDis(2);
			System.out.println("drip-y:"+y+",dDis:"+_Dript_Dis);
